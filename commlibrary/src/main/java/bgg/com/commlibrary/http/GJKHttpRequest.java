...
import bgg.com.commlibrary.utils.HttpUtils;
...
public abstract class GJKHttpRequest {
	 ...
	 * @param response
	 */
	public abstract void requestDidSuccessful(int method, JSONObject response);
	 ...
	 * @param errorMsg
	 */
	public abstract void requestDidError(int method, int code, String errorMsg);
	...
	public void requestWithMethod(int method) {
		...
		// 创建json请求
		request = new JsonObjectRequest(method, url.toString(), params, listener, errorListener);
	...
	public void startDeleteRequest() {
		requestWithMethod(Method.DELETE);
	}
	...
	public void startPatchRequest() {
		requestWithMethod(Method.PATCH);
	}
